...
function flushSyncWorkAcrossRoots_impl(syncTransitionLanes, onlyLegacy) {
  if (!isFlushingWork && mightHavePendingSyncWork) {
    ...
    do {
      ...
      for (var root$13 = firstScheduledRoot; null !== root$13; ) {
        if (!onlyLegacy)
          if (0 !== syncTransitionLanes) {
            var pendingLanes = root$13.pendingLanes;
            if (0 === pendingLanes) var JSCompiler_inline_result = 0;
            else {
              var suspendedLanes = root$13.suspendedLanes,
                pingedLanes = root$13.pingedLanes;
            ...
            0 !== JSCompiler_inline_result &&
              ...
              performSyncWorkOnRoot(root$13, JSCompiler_inline_result));
          } else
            (JSCompiler_inline_result = workInProgressRootRenderLanes),
              (JSCompiler_inline_result = getNextLanes(
                root$13,
                root$13 === workInProgressRoot ? JSCompiler_inline_result : 0,
                null !== root$13.cancelPendingCommit ||
                  -1 !== root$13.timeoutHandle
              )),
              0 === (JSCompiler_inline_result & 3) ||
                checkIfRootIsPrerendering(root$13, JSCompiler_inline_result) ||
                ((didPerformSomeWork = !0),
                performSyncWorkOnRoot(root$13, JSCompiler_inline_result));
        root$13 = root$13.next;
      }
...
function runActionStateAction(actionQueue, node) {
  ...
  if (node.isTransition) {
    ...
    try {
      ...
      onActionError(actionQueue, node, error$30);
    }
}
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$33 = enqueueUpdate(provider, fiber, lane);
        null !== root$33 &&
          (scheduleUpdateOnFiber(root$33, provider, lane),
          entangleTransitions(root$33, provider, lane));
...
function resolveClassComponentProps(Component, baseProps) {
  ...
  if ((Component = Component.defaultProps)) {
    ...
    for (var propName$66 in Component)
      void 0 === newProps[propName$66] &&
        (newProps[propName$66] = Component[propName$66]);
  }
  return newProps;
}
  ...
  if (didBailout)
    for (var child$106 = completedWork.child; null !== child$106; )
      (newChildLanes |= child$106.lanes | child$106.childLanes),
        (subtreeFlags |= child$106.subtreeFlags & 29360128),
        (subtreeFlags |= child$106.flags & 29360128),
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        cache$119 !== type && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
  ...
  if (null !== ref)
    if ("function" === typeof refCleanup)
      ...
      try {
        ...
        captureCommitPhaseError(current, nearestMountedAncestor, error$135);
      }
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$142 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$142;
      if (null !== hostParent)
      ...
      if (27 !== finishedWork.tag) {
        ...
        switch (JSCompiler_inline_result.tag) {
          case 27:
            ...
            break;
          case 5:
            var parent$136 = JSCompiler_inline_result.stateNode;
            JSCompiler_inline_result.flags & 32 &&
              (setTextContent(parent$136, ""),
              (JSCompiler_inline_result.flags &= -33));
            var before$137 = getHostSibling(finishedWork);
            insertOrAppendPlacementNode(finishedWork, before$137, parent$136);
            break;
          case 3:
          case 4:
            var parent$138 = JSCompiler_inline_result.stateNode.containerInfo,
              before$139 = getHostSibling(finishedWork);
  ...
  if (1 === pendingEffectsStatus) {
    ...
    if (0 !== (finishedWork.subtreeFlags & 13878) || rootMutationHasEffect) {
      ...
      try {
        ...
        target = selectionInformation;
        var curFocusedElem = getActiveElementDeep(root.containerInfo),
          priorFocusedElem = target.focusedElem,
          priorSelectionRange = target.selectionRange;
        if (
...
function flushLayoutEffects() {
  if (2 === pendingEffectsStatus) {
    ...
    if (null !== recoverableErrors) {
      finishedWork = ReactSharedInternalsServer.T;
      rootHasLayoutEffect = ReactDOMSharedInternals$1.p;
      ReactDOMSharedInternals$1.p = 2;
      ReactSharedInternalsServer.T = null;
      try {
        ...
        (ReactSharedInternalsServer.T = finishedWork),
          (ReactDOMSharedInternals$1.p = rootHasLayoutEffect);
      }
    }
    ...
    if (null === value) node.removeAttribute(name);
      ...
      switch (typeof value) {
        ...
        case "symbol":
          ...
          return;
        case "boolean":
          var prefix$176 = name.toLowerCase().slice(0, 5);
          if ("data-" !== prefix$176 && "aria-" !== prefix$176) {
            node.removeAttribute(name);
            return;
          }
      }
      ...
      !prevStyles.hasOwnProperty(styleName) ||
        ...
        (0 === styleName.indexOf("--")
          ...
          : "float" === styleName
            ? (node.cssFloat = "")
            : (node[styleName] = ""));
    for (var styleName$182 in styles)
      (styleName = styles[styleName$182]),
        styles.hasOwnProperty(styleName$182) &&
          prevStyles[styleName$182] !== styleName &&
          setValueForStyle(node, styleName$182, styleName);
  } else
    for (var styleName$183 in styles)
      styles.hasOwnProperty(styleName$183) &&
        setValueForStyle(node, styleName$183, styles[styleName$183]);
}
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1480 = "oninput" in document;
    if (!isSupported$jscomp$inline_1480) {
      var element$jscomp$inline_1481 = document.createElement("div");
      element$jscomp$inline_1481.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1480 =
        "function" === typeof element$jscomp$inline_1481.oninput;
    }
    JSCompiler_inline_result$jscomp$331 = isSupported$jscomp$inline_1480;
  ...
  switch (type) {
    ...
    case "link":
      if (
        ...
        var styles$255 = getResourcesFromRoot(
            JSCompiler_inline_result
          ).hoistableStyles,
          resource$256 = styles$255.get(type);
        resource$256 ||
          ((JSCompiler_inline_result =
          ...
          styles$255.set(type, resource$256),
          (styles$255 = JSCompiler_inline_result.querySelector(
            getStylesheetSelectorFromKey(type)
          )) &&
            !styles$255._p &&
            ((resource$256.instance = styles$255),
            (resource$256.state.loading = 5)),
