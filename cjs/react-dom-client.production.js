...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$286 = isSupported$jscomp$inline_423;
  ...
  if (didBailout)
    for (var child$136 = completedWork.child; null !== child$136; )
      (newChildLanes |= child$136.lanes | child$136.childLanes),
        (subtreeFlags |= child$136.subtreeFlags & 31457280),
        (subtreeFlags |= child$136.flags & 31457280),
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    var prevExecutionContext = executionContext;
    executionContext |= 4;
    var shouldFireAfterActiveInstanceBlur$170 = commitBeforeMutationEffects(
      root,
      finishedWork
    );
    commitMutationEffectsOnFiber(finishedWork, root);
    shouldFireAfterActiveInstanceBlur$170 &&
      ((_enabled = !0),
...
for (
  var i$jscomp$inline_1478 = 0;
  i$jscomp$inline_1478 < simpleEventPluginEvents.length;
  i$jscomp$inline_1478++
) {
  var eventName$jscomp$inline_1479 =
      simpleEventPluginEvents[i$jscomp$inline_1478],
    domEventName$jscomp$inline_1480 =
      eventName$jscomp$inline_1479.toLowerCase(),
    capitalizedEvent$jscomp$inline_1481 =
      eventName$jscomp$inline_1479[0].toUpperCase() +
      eventName$jscomp$inline_1479.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1480,
    "on" + capitalizedEvent$jscomp$inline_1481
  );
}
