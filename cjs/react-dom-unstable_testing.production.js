...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$289 = isSupported$jscomp$inline_428;
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$123 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$123;
      if (null !== hostParent)
  ...
  if (!isHydrating)
    switch (renderState.tailMode) {
      ...
      case "collapsed":
        ...
        for (var lastTailNode$137 = null; null !== lastTailNode; )
          null !== lastTailNode.alternate && (lastTailNode$137 = lastTailNode),
            (lastTailNode = lastTailNode.sibling);
        null === lastTailNode$137
          ? hasRenderedATailFallback || null === renderState.tail
            ? (renderState.tail = null)
            : (renderState.tail.sibling = null)
          : (lastTailNode$137.sibling = null);
    }
}
function bubbleProperties(completedWork) {
  var didBailout =
    ...
    subtreeFlags = 0;
  if (didBailout)
    for (var child$138 = completedWork.child; null !== child$138; )
      (newChildLanes |= child$138.lanes | child$138.childLanes),
        (subtreeFlags |= child$138.subtreeFlags & 31457280),
        (subtreeFlags |= child$138.flags & 31457280),
        (child$138.return = completedWork),
        (child$138 = child$138.sibling);
  else
    for (child$138 = completedWork.child; null !== child$138; )
      (newChildLanes |= child$138.lanes | child$138.childLanes),
        (subtreeFlags |= child$138.subtreeFlags),
        (subtreeFlags |= child$138.flags),
        (child$138.return = completedWork),
        (child$138 = child$138.sibling);
  ...
  switch (workInProgress.tag) {
    ...
    case 13:
      ...
      if (renderLanes) {
        ...
        null !== newProps.memoizedState &&
          ...
          (cache$150 = newProps.memoizedState.cachePool.pool);
        cache$150 !== type && (newProps.flags |= 2048);
      }
      renderLanes !== current &&
        renderLanes &&
    ...
    case 19:
      ...
      if (null === cache$150)
        if (newProps) cutOffTailIfNeeded(type, !1);
          ...
          if (
            ...
            for (current = workInProgress.child; null !== current; ) {
              cache$150 = findFirstSuspended(current);
              if (null !== cache$150) {
                workInProgress.flags |= 128;
                cutOffTailIfNeeded(type, !1);
                current = cache$150.updateQueue;
                workInProgress.updateQueue = current;
        ...
        if (!newProps)
          if (((current = findFirstSuspended(cache$150)), null !== current)) {
            if (
              ((workInProgress.flags |= 128),
              (newProps = !0),
              (current = current.updateQueue),
            ...
            2 * now() - type.renderingStartTime >
              ...
              (workInProgress.lanes = 4194304));
        type.isBackwards
          ? ((cache$150.sibling = workInProgress.child),
            (workInProgress.child = cache$150))
          : ((current = type.last),
            null !== current
              ? (current.sibling = cache$150)
              : (workInProgress.child = cache$150),
            (type.last = cache$150));
      }
      if (null !== type.tail)
...
function commitRootImpl(
  ...
  if (0 !== (finishedWork.subtreeFlags & 15990) || transitions) {
    ...
    shouldFireAfterActiveInstanceBlur$173 &&
      ((_enabled = !0),
...
function flushPassiveEffects() {
  if (null !== rootWithPendingPassiveEffects) {
    var root$174 = rootWithPendingPassiveEffects,
    ...
    try {
      ...
      (ReactDOMSharedInternals.p = previousPriority),
        (ReactSharedInternals.T = prevTransition),
        releaseRootPooledCache(root$174, remainingLanes);
    }
  }
  return !1;
}
...
for (
  var i$jscomp$inline_1505 = 0;
  i$jscomp$inline_1505 < simpleEventPluginEvents.length;
  i$jscomp$inline_1505++
) {
  var eventName$jscomp$inline_1506 =
      simpleEventPluginEvents[i$jscomp$inline_1505],
    domEventName$jscomp$inline_1507 =
      eventName$jscomp$inline_1506.toLowerCase(),
    capitalizedEvent$jscomp$inline_1508 =
      eventName$jscomp$inline_1506[0].toUpperCase() +
      eventName$jscomp$inline_1506.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1507,
    "on" + capitalizedEvent$jscomp$inline_1508
  );
}
...
var internals$jscomp$inline_2238 = {
  bundleType: 0,
