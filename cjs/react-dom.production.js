...
function flushLayoutEffects() {
  if (2 === pendingEffectsStatus) {
    ...
    if (null !== recoverableErrors) {
      ...
      rootHasLayoutEffect = Internals.p;
      Internals.p = 2;
      ReactSharedInternals.T = null;
      try {
        ...
        (ReactSharedInternals.T = finishedWork),
          (Internals.p = rootHasLayoutEffect);
      }
    }
...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    var isSupported$jscomp$inline_1479 = "oninput" in document;
    if (!isSupported$jscomp$inline_1479) {
      var element$jscomp$inline_1480 = document.createElement("div");
      element$jscomp$inline_1480.setAttribute("oninput", "return;");
      isSupported$jscomp$inline_1479 =
        "function" === typeof element$jscomp$inline_1480.oninput;
    }
    JSCompiler_inline_result$jscomp$331 = isSupported$jscomp$inline_1479;
...
for (
  var i$jscomp$inline_1520 = 0;
  i$jscomp$inline_1520 < simpleEventPluginEvents.length;
  i$jscomp$inline_1520++
) {
  var eventName$jscomp$inline_1521 =
      simpleEventPluginEvents[i$jscomp$inline_1520],
    domEventName$jscomp$inline_1522 =
      eventName$jscomp$inline_1521.toLowerCase(),
    capitalizedEvent$jscomp$inline_1523 =
      eventName$jscomp$inline_1521[0].toUpperCase() +
      eventName$jscomp$inline_1521.slice(1);
  registerSimpleEvent(
    domEventName$jscomp$inline_1522,
    "on" + capitalizedEvent$jscomp$inline_1523
  );
}
