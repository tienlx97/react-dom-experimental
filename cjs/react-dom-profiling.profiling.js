...
if (canUseDOM) {
  ...
  if (canUseDOM) {
    ...
    JSCompiler_inline_result$jscomp$311 = isSupported$jscomp$inline_443;
  ...
  for (var provider = fiber.return; null !== provider; ) {
    switch (provider.tag) {
      ...
      case 3:
        ...
        var root$48 = enqueueUpdate(provider, fiber, lane);
        null !== root$48 &&
          (startUpdateTimerByLane(lane),
          scheduleUpdateOnFiber(root$48, provider, lane),
          entangleTransitions(root$48, provider, lane));
...
function commitDeletionEffectsOnFiber(
  ...
  switch (deletedFiber.tag) {
    ...
    case 6:
      ...
      var prevHostParentIsContainer$133 = hostParentIsContainer;
      hostParent = null;
      recursivelyTraverseDeletionEffects(
        finishedRoot,
        nearestMountedAncestor,
      ...
      hostParentIsContainer = prevHostParentIsContainer$133;
      if (null !== hostParent)
      ...
      if (27 !== finishedWork.tag) {
        ...
        switch (JSCompiler_inline_result.tag) {
          case 27:
            ...
            break;
          case 5:
            var parent$126 = JSCompiler_inline_result.stateNode;
            JSCompiler_inline_result.flags & 32 &&
              (setTextContent(parent$126, ""),
              (JSCompiler_inline_result.flags &= -33));
            var before$127 = getHostSibling(finishedWork);
            insertOrAppendPlacementNode(finishedWork, before$127, parent$126);
            break;
          case 3:
          case 4:
            var parent$128 = JSCompiler_inline_result.stateNode.containerInfo,
              before$129 = getHostSibling(finishedWork);
      ...
      (null !== wasInHydratedSubtree &&
        ...
        : ((wasInHydratedSubtree = finishedWork.deletions),
          ...
          18 === wasInHydratedSubtree[0].tag
            ? ((inHydratedSubtree = !1),
              null !== prevEffectDuration.hydrationErrors &&
                logComponentErrored(
                  finishedWork,
                  finishedWork.actualStartTime,
                  endTime
